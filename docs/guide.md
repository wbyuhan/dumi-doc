...
- 项目简介：管理中心是综合管理 CPSDK 和发行 SDK 全局配置的平台，SDK 管理人员可通过管理中心对多个发行 SDK 平台进行集中管理和配置。
...
- 入口&环境：
  - [UAT 环境](https://admin-webmin-uat.iwgame.com/)&emsp;https://admin-webmin-uat.iwgame.com/
